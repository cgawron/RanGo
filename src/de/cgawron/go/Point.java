...
public class Point implements Comparable<Point>
{
	 ...
	 *             if the argument is not an instance of Point.
	 * @param p
	 *            - the <code>Point</code> to compare to
	 ...
	 * 
	 * @return java.util.Enumeration repr public java.util.Enumeration
	 * neighbors() { return null; }
	 */
	 ...
	 * 
	 * @param b
	 *            - the StringBuffer to which the String is appended.
	 * @param p
	 *            - the point to append.
